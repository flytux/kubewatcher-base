...
const SMSSO_LOGIN_FCC = '/sso/mock-sso-login'; // sso login web url
...
const SYSTEM_DOMAIN = 'http://127.0.0.1:8080'; // system domain
...
const SMSSO_PROXY_ROOT = SYSTEM_ROOT + ''; // sso proxy web server mapping (proxy type only)
...
const SMSSO_PROTECTED_PAGE = SMSSO_PROXY_ROOT + '/sso/mock-protected-page'; // login target page for siteminder sso
